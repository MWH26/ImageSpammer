...
## if ImageLink == "d":
ImageLink = "https://upload.wikimedia.org/wikipedia/commons/3/35/Beypazar%C4%B1_H%C4%B1rkatepe_K%C3%B6y_%C3%A7e%C5%9Fmesi.jpg"
...
## if ImageName == "d":
ImageName = "Beypazarı_Hırkatepe_Köy_çeşmesi.png"
